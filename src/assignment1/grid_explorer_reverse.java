...
public class grid_explorer_reverse {
      ...
      */
      ...
      public static void main (String[] args){
            ...
            // MODIFY when using another direction.
            lcd.drawString(5-red_pos[0]%6 + "," + red_pos[0]/6 +"R",1,1);
            lcd.drawString(5-red_pos[1]%6 + "," + red_pos[1]/6 +"R",1,3);
            lcd.drawString(5-block_pos[0]%6 + "," + block_pos[0]/6 +"B",1,5);
            lcd.drawString(5-block_pos[1]%6 + "," + block_pos[1]/6 +"B",1,7);
